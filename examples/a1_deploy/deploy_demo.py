...
class A1ArmDeploy:
    ...
    def __init__(self, controller, model_type="pi0", 
        ...
        self.position_presets = {
            ...
            "stack_cup": (0.4, 0.28, 0.28, 0.00, 0.00, 1, 0, 1),  # demo set
        ...
        self.pos_limits = {
            "x_min": 0.37, "x_max": 0.425,  #0.2/0.40 for demo pick bowl, 0.35/0.45 for demo stack cup
            # "x_min": 0.3, "x_max": 0.47,
            "y_min": -0.02, "y_max": 0.4, # -0.02/0.32 for demo "pick bowl", -0.05/0.35 for demo "stack cup"
    ...
    def run_control_loop(self, n_iterations=200, chunk_size=4, merge_step=2, loop_interval=0.1):
        ...
        print(f"Prompt: {prompt}, model_name: {self.model_type}")
            ...
            while step < n_iterations:
                ...
                if self.model_type in ["pi0", "memo-vla"]:
                    ...
                    for step_idx in range(0, n_steps, merge_step):
                        ...
                        if task_name =="pick_bowl" and self.model_type == "memo-vla":
                        ...
                        if task_name == "stack_cup" and self.model_type == "memo-vla":
                        ...
                        if task_name == "stack_cup" and self.model_type == "pi0":
                            if step > 45 and grip <0.3:
                                if new_pos[1] > 0.04 and new_pos[2] > 0.28:
                                    new_pos[1] = 0.02
